...
{
    public class TranslatedDateTimePicker : DateTimePicker
    {
        ...
        protected override Type StyleKeyOverride => typeof(DateTimePicker);
        ...
        public static readonly DirectProperty<TranslatedDateTimePicker, object?> ValueProperty =
            AvaloniaProperty.RegisterDirect<TranslatedDateTimePicker, object?>(
                nameof(Value),
                o => o.Value,
                (o, v) => o.Value = v);
        ...
        private void UpdateDisplayValue()
        {
            ...
            SelectedDateTime = dateTimeConverter.UtcToDisplay(DateTime.Value, DisplayMode);
        }
        ...
        private void UpdateRawValue()
        {
            ...
            Value = dateTimeConverter.DisplayToUtc(selectedDate.Value, DisplayMode);
        }
    }
}
